...
public class Databaseinit implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Content content1 = new Content("Contenido A", "Descripción A", "Autor A", "Fuente A", List.of(tag1, tag2));
        Content content2 = new Content("Contenido B", "Descripción B", "Autor B", "Fuente B", List.of(tag3, tag4));
        Content content3 = new Content("Contenido C", "Descripción C", "Autor C", "Fuente C", List.of(tag5, tag6));
